...
export const WALKTHROUGH = [
...

  {
    ...
    body: [
      'This follows from the documented flight. The Montana-to-Albany leg, flown nonstop as reported, is 1,843 miles in one hop, which no F-16 flies without external fuel tanks [[dropTanks]]. So the tanks are established by the trip he made.',
...

  {
    ...
    counter: {
      ...
      text: 'The objection is correct on the facts. Cleveland Center [[faa]] heard the hijacking live at 09:28 and never lost the aircraft. But air traffic control [[atc]] does not task fighters. The request to the military was discussed at 09:36, again at 09:49, and still being discussed at 09:53; it was never made. The Who knew tab documents the chain minute by minute.',
      more: 'awareness',
    },
    src: 'commission',
    refs: ['COMMISSION', 'NEADS'],
...

  {
    ...
    body: [
      ...
      'Jacoby was in Montana. He was collected there, reached Albany, and has said so. He is the one first-hand witness to Gibney\'s flight that day.',
...

  {
    ...
    counter: {
      ...
      text: 'It is, and the discrepancy register lists every gap the app knows about, including its own. His unit, his passenger and his own account all put him on the Montana trip that morning; no timed log of the flight has been published.',
    },
    src: 'press',
    refs: ['AIM9'],
