...
export const CONFLICTS = [
  ...
  },
  {
    ...
    tags: ['DATA'],
    status: 'todo',
    why: 'A smooth line on a 3D map reads as measurement. Three of these four are not.',
    readings: [
      ...
      { v: '9–12 hand-placed waypoints, one per ~6 minutes', who: 'AA11, UA175 and AA77 in this app', src: 'derived', weight: 'Interpolated with great circles between anchors.' },
      { v: 'FDR altitudes; lateral track traced by eye from a printed map', who: 'UA93 in this app', src: 'ntsb', weight: 'Vertically sound, laterally approximate.' },
    ],
    reading: 'No RADES file is plotted anywhere in this app. AA77 has an NTSB Flight Path Study of its own that has not been incorporated yet; AA11 and UA175 have no FDR at all, since their recorders were never recovered.',
    appSays: 'Tracks are badged RECONSTRUCTED. UA93 is badged NTSB / FDR for altitude only.',
  },
];
